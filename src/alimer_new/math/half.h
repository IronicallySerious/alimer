...
// Code taken from filament: https://github.com/google/filament/blob/master/libs/math/include/math/half.h
...
namespace alimer {
    ...
    */
        ...
        constexpr half::fp16 half::ftoh(float f) noexcept {
            ...
            in.setS(0);
            if (ALIMER_UNLIKELY(in.getE() == 0xFF)) { // inf or nan
                out.setE(0x1F);
...
namespace std {
    ...
    template<> struct is_floating_point<alimer::math::half> : public std::true_type {};

    template<>
    class numeric_limits<alimer::math::half> {
    public:
        typedef alimer::math::half type;
        ...
        inline static constexpr type round_error() noexcept { return alimer::math::makeHalf(0x3800); }
        inline static constexpr type min() noexcept { return alimer::math::makeHalf(0x0400); }
        inline static constexpr type max() noexcept { return alimer::math::makeHalf(0x7bff); }
        inline static constexpr type lowest() noexcept { return alimer::math::makeHalf(0xfbff); }
        inline static constexpr type epsilon() noexcept { return alimer::math::makeHalf(0x1400); }
        inline static constexpr type infinity() noexcept { return alimer::math::makeHalf(0x7c00); }
        inline static constexpr type quiet_NaN() noexcept { return alimer::math::makeHalf(0x7fff); }
        inline static constexpr type denorm_min() noexcept { return alimer::math::makeHalf(0x0001); }
        inline static constexpr type signaling_NaN() noexcept { return alimer::math::makeHalf(0x7dff); }
    };
} // namespace std
